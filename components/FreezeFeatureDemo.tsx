        ...
        <div className="flex flex-col w-full h-screen relative bg-slate-800">
            ...
            <div className="h-4/5 relative overflow-hidden">
                ...
                <div className="w-full h-full flex items-center justify-center bg-gray-900">
                    ...
                    {isFrozen && (
                        <div className="absolute top-5 right-5 bg-black bg-opacity-50 px-3 py-2 rounded-xl flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M2 12h20M12 2v20M20 16l-4-4 4-4M4 8l4 4-4 4M16 4l-4 4-4-4M8 20l4-4 4 4" />
                            </svg>
                            <span className="ml-2 font-bold text-white">FROZEN</span>
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="flex flex-row justify-between items-center mb-4">
                    ...
                    <div className="flex">
                        ...
                        <button
                            ...
                            style={{
                                backgroundColor: isFrozen ? SUCCESS_COLOR : SURFACE_COLOR,
                            }}
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="none"
                                stroke={isFrozen ? BACKGROUND_COLOR : SECONDARY_COLOR}
                                strokeWidth="2"
                                strokeLinecap="round"
            ...
            <div className="absolute top-4 right-4 bg-white p-3 rounded-lg shadow-lg">
                <div className="flex items-center justify-between mb-3">
                    <button
                        ...
                        style={{
                            backgroundColor: isFrozen ? SUCCESS_COLOR : PRIMARY_COLOR,
                            color: 'white'
                        }}
                        onClick={toggleFreeze}
                    >
                    ...
                    <span className="text-xs" style={{ color: SECONDARY_COLOR }}>
                        {isFrozen ? 'Camera paused' : 'Camera active'}
                    </span>
                </div>
                <div className="text-xs text-center mb-2" style={{ color: SECONDARY_COLOR }}>
                    {isFrozen ?
                        'Camera toggle disabled while frozen' :
                        'Try freezing to examine details'
                    }
                </div>
            </div>
        </div>
...
export default FreezeFeatureDemo;